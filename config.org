...
- [[#initial-modules-to-load][INITIAL MODULES TO LOAD]]
...
#+begin_src emacs-lisp
  (use-package general
    ...
    (ta/leader-keys
      ...
      "g" '(counsel-imenu :wk "Go to in file")
    ...
    (ta/leader-keys    
      ...
      "m p" '(markdown-toggle-markup-hiding  :wk "Toggle Markdown Preview"))
...
(defun kill-all-processes ()
  "Kill all active processes in Emacs."
  (interactive)
...
#+begin_src emacs-lisp
  ...
  (use-package markdown-mode
    ...
    ;; Configure header appearance with variable pitch fonts
    (custom-set-faces
